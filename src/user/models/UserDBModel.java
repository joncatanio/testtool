...
public abstract class UserDBModel {
     ...
     * and may be omitted.
      ...
      post:
        ...
        //
        forall (UserModel um_other ;
            (users'.contains(um_other)) iff
                users.equals(um) || users.contains(um_other));
     */
     ...
     *
      post:
        ...
        // is null.
        //
        exists (UserModel um_found ; users.contains(um_found) ;
     ...
     *
      post:
        ...
        //
        exists (UserModel um_found ; users.contains(um_found) ;
                um_found.username.equals(username) && um_found.equals(return))
            ||
        !exists (UserModel um_found ; users.contains(um_found) ;
                um_found.username.equals(username)) && return == null;
     */
